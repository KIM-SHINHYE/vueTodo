    ...
    <main>
        <div>
            ...
            <div>
                ...
                <ol>
                    ...
                    <li>
                        <br>
                        <ul>
                            <li>getter: 계산형 데이터 속성이 계산되는 방식 정의 => 계산형 데이터 속성을 사용할 때마다 실행</li>
                            <ul>
            ...
            <div>
                <h1>4. BEAST에서의 사용</h1>
                <p>get사용: </p>
                <p>get,set 사용: get에 부모로부터 받은 데이터를 가져오고, set에 사용자가 입력한 값에 대한 변화가 있으면 그에 대한 유효성 체크를 한 후, 다시 부모 컴포넌트에 emit하는 형태</p>
            </div>
            <br>
            <div>
                <ComputedWatch>
